...
**Objective:** Create a ~2:45 minute video that hooks the judges, clearly demonstrates the core "magic" of the app, and explicitly details the innovative use of the Gemini 3 API.
...
**(0:30 - 0:50) - Perfect Form & Gentle Correction**

*   **Visual:** Full-screen recording of the `ActiveSession`. A person is doing squats with good form. The screen border glows green, and the skeleton overlay is calm. The "Coach Log" shows messages like "Perfect!" and "Great depth!".
*   **Narrator (Voiceover):** "Kinetix uses your webcam to analyze your movement. When your form is good, the interface glows green, giving you positive reinforcement."
*   **Visual:** The person on screen makes a minor mistake (e.g., doesn't go deep enough). The screen glows yellow, the skeleton highlights the legs, and the Coach Log says "A little deeper!". An audio cue plays.
...
**(0:50 - 1:10) - Critical Correction & The "Brain"**
...
*   **Narrator (Voiceover):** "But for dangerous movements, Kinetix intervenes immediately to prevent injury. This is where the magic of Gemini comes in."
...
*   **Narrator (Voiceover):** "It shows you what you did well, what you need to work on, and even gives you personalized recommendations for corrective exercises."

---

### **Part 3: The Gemini 3 Integration (1:30 - 2:30)**

**(1:30 - 2:00) - How It's Built: Multimodality & Reasoning**
...
**(2:00 - 2:30) - How It's Built: Large Context & TTS**
